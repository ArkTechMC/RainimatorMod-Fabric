...
public class ModelCustomModel<T extends Entity> extends EntityModel<T> {
    public static final EntityModelLayer LAYER_LOCATION = new EntityModelLayer(new Identifier(RainimatorMod.MOD_ID, "model_custom_model"), "main");
    ...
    public static TexturedModelData createBodyLayer() {
        ...
        ModelPartData Head = partdefinition.addChild("Head",
                ModelPartBuilder.create().uv(0, 21).cuboid(-5.0F, -9.0F, -5.0F, 10.0F, 2.0F, 1.0F, new Dilation(0.0F)).uv(0, 35).cuboid(-5.0F, -10.0F, -5.0F, 1.0F, 1.0F, 1.0F, new Dilation(0.0F)).uv(22, 16)
                        .cuboid(-3.0F, -10.0F, -5.0F, 6.0F, 1.0F, 1.0F, new Dilation(0.0F)).uv(34, 34).cuboid(4.0F, -10.0F, -5.0F, 1.0F, 1.0F, 1.0F, new Dilation(0.0F)).uv(5, 24)
                        .cuboid(-1.0F, -11.0F, -5.0F, 2.0F, 1.0F, 1.0F, new Dilation(0.0F)).uv(0, 16).cuboid(-0.8F, -10.0F, -5.2F, 1.6F, 1.4F, 0.2F, new Dilation(0.0F)).uv(0, 18)
                        .cuboid(-0.8F, -8.6F, -5.1F, 1.6F, 0.5F, 0.1F, new Dilation(0.0F)).uv(7, 0).cuboid(-1.4F, -10.0F, -5.1F, 0.6F, 1.4F, 0.1F, new Dilation(0.0F)).uv(3, 0)
