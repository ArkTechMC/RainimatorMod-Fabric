...
public class RainArmorItem extends ArmorItem {
    public RainArmorItem(Type slot, Item.Settings properties) {
        super(ArmorMaterialUtil.of("rain_armors", new int[]{13, 15, 16, 11}, 20, new int[]{0, 0, 20, 0}, 30, Registries.SOUND_EVENT.get(new Identifier("item.armor.equip_diamond")), 0.0F, 0.0F, ModItems.SUPER_SAPPHIRE, ModItems.RAIN_CHESTPLATE), slot, properties);
    }
