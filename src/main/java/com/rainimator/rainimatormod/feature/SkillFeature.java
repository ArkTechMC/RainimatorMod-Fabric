...
public class SkillFeature extends Feature<DefaultFeatureConfig> {
    ...
    public static Feature<?> feature() {
        ...
        CONFIGURED_FEATURE = ConfiguredFeatures.register(RainimatorMod.MOD_ID + ":skill", FEATURE, FeatureConfig.DEFAULT);
        PLACED_FEATURE = PlacedFeatures.register(RainimatorMod.MOD_ID + ":skill", CONFIGURED_FEATURE, List.of());
        return FEATURE;
    }
    ...
    public boolean generate(FeatureContext<DefaultFeatureConfig> context) {
        ...
        if (this.template == null)
            this.template = context.getWorld().toServerWorld().getStructureManager().getStructureOrBlank(new Identifier(RainimatorMod.MOD_ID, "skill"));
