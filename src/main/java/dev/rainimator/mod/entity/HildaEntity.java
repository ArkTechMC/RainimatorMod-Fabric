...
public class HildaEntity extends MonsterEntityBase implements RangedAttackMob {
    ...
    public HildaEntity(EntityType<HildaEntity> type, World world) {
        ...
        this.equipStack(EquipmentSlot.OFFHAND, new ItemStack(RainimatorItems.BLUE_DIAMOND_SHIELD));
    }
    ...
    public void attack(LivingEntity target, float flval) {
        HildaEntityProjectile entityarrow = new HildaEntityProjectile(RainimatorEntities.HILDA_PROJECTILE, this, this.getWorld());
