...
public class CerisEntity extends MonsterEntityBase {
    ...
    public CerisEntity(EntityType<CerisEntity> type, World world) {
        ...
        this.setPersistent();
        this.equipStack(EquipmentSlot.MAINHAND, new ItemStack(RainimatorItems.ENDER_BIG_SWORD));
    }
            ...
            if (Math.random() < 0.3D) {
                ...
                if (sourceentity instanceof LivingEntity livingEntity) {
                    if (!livingEntity.getWorld().isClient())
                        livingEntity.addStatusEffect(new StatusEffectInstance(RainimatorEffects.FEAR_DARK, 200, 0));
